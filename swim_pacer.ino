        ...
        <div id="main" class="page active">
            ...
            <div class="control">
                ...
                <div class="button-group" id="configButtons">
                    <button class="big-button" onclick="createSwimSet()" id="createSetBtn">Create Set</button>
                </div>
                <div class="button-group" id="queueButtons" style="display: none;">
                    ...
                    <button class="big-button" onclick="cancelSwimSet()" id="cancelBtn" style="background: #dc3545;">Cancel</button>
                </div>
